...
SCHEMA_PATH = Path('C:/Users/sneha/Desktop/supplier-risk-detector/backend/prisma/generated/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\sneha\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    chatlog: 'actions.ChatLogActions[models.ChatLog]'
    ...
    def __init__(
        ...
        *,
        ...
        self.chatlog = actions.ChatLogActions[models.ChatLog](self, models.ChatLog)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/sneha/Desktop/supplier-risk-detector/backend/prisma/generated/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.chatlog = ChatLogBatchActions(self)
