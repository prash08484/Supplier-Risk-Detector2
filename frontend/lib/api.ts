const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE || "https://supplier-risk-detector2.onrender.com/api/v1" || "http://localhost:8000/api/v1"; // Fallback to local development URL
